...
if(!isset($objetoJsonRecebido['nomeUsuario']) || !isset($objetoJsonRecebido['emailUsuario']) || !is_numeric($objetoJsonRecebido['isProfessor'])){
...
if($dadosObtidos === false){
	//adiciona usuario
	if($usuarioObj->insereNovoUsuario($objetoJsonRecebido['nomeUsuario'], $objetoJsonRecebido['emailUsuario'], $objetoJsonRecebido['isProfessor'])){
